      ...
      <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6 font-sans theme-enterprise-blue">
        <div className="w-full max-w-sm bg-card border border-border rounded-2xl p-8 space-y-6 shadow-sm">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <a href="/login/forgot" className="text-[10px] text-primary hover:text-hover hover:underline">Forgot?</a>
              </div>
              <input
                type="password"
                required
          ...
          <div className="text-center text-xs text-muted-foreground pt-2 border-t border-border">
            ...
            <Link href="/register" className="text-primary hover:text-hover hover:underline">
              Create free trial
            </Link>
          </div>
        </div>
